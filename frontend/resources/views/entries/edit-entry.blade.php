...
<div class="container">
    <div class="row justify-content-center">
        <div class="col-md-8">
            <div class="card">
                <div class="card-header">Update entry</div>
                    ...
                    <form method="POST" action="/update-entry">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                ...
                                <input type="number" placeholder="0.00" name="value" min="0" value="{{$entry['value']}}" step="0.01" required>
                            </div>
                        </div>
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input type="date" name="payment_date" value="{{$entry['payment_date']}}" required>
                            </div>
                        </div>
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input type="text" name="status" value="{{$entry['payment_date']}}" required>
                            </div>
                        </div>
                        <div class="form-group row">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <select class="form-control" id="entry_type_id" name="entry_type_id">
                                    ...
                                    <option value="{{ $entrytype->id }}"
                                    @if ($entrytype->id == $entry->entry_type_id)
                                        selected="selected"
                                    @endif
                                    >{{$entrytype->name }}</option>
                                    @endforeach
                                </select>
                            </div>
                        </div>
